// src/render/scenes/LightingLab.tsx
//
...
import { CELL, WALL_HEIGHT, WALL_THICKNESS, compileGrid, roofFor } from '../../core/house/grid';
import { defineRoom, type Grid, type RoomLabels } from '../../core/house/blocks';
import { LOCALES, type Locale } from '../../core/house/labels';
import { assertNever } from '../../core/shared/errors';
...
import { EXTERIOR_RIG, INTERIOR_RIG, type LightRig } from '../../core/style/lights';

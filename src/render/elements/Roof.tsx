...
//
// Geometry lives in core/geometry/roofSurface (pure, node-runnable) and becomes
// drawable via ../three/meshGeometry (the three adapter). BOTH halves of the roof go
...
import { corrugate, gableMesh } from '../../core/geometry/roofSurface';

...
export const JANUARY_PLAN: readonly Storey[] = furnish(BASE_PLAN, {
  0: {
    ...
    items: [
      ...
      { id: 'dining-chair-e', kind: 'chair', mount: { on: 'floor', cell: [3, 5], facing: 'w', offset: [-0.15, 0.45] } },
      ...
      { id: 'living-table', kind: 'table', mount: { on: 'floor', cell: [6, 4], facing: 's', offset: [0, -0.15] } },
      { id: 'work-laptop', kind: 'laptop', mount: { on: 'item', host: 'living-table', offset: [-0.2, -0.1] } },
      { id: 'living-sofa', kind: 'sofa', mount: { on: 'floor', cell: [7, 4], facing: 'n', offset: [0, 0.05] } },
      ...
      { id: 'reading-chair', kind: 'chair', mount: { on: 'floor', cell: [5, 8], facing: 's', offset: [0, 0.05] } },
    ],
  },
  1: {
    openings: [
